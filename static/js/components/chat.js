...
function setBotResponse(response) {
    ...
    setTimeout(() => {
        ...
        if (response.length < 1) {
            ...
            const fallbackMsg = "Estoy teniendo problemas, por favor intenta más tarde";
...
function actionTrigger() {
    $.ajax({
        url: `https://n4qgczfrbg.execute-api.us-east-1.amazonaws.com/prod/conversations/${sender_id}/execute`,
        type: "POST",
        contentType: "application/json",
        data: JSON.stringify({
            name: action_name,
...
function customActionTrigger() {
    $.ajax({
        url: "https://n4qgczfrbg.execute-api.us-east-1.amazonaws.com/prod/webhooks/rest/webhook",
        type: "POST",
        contentType: "application/json",
        data: JSON.stringify({
